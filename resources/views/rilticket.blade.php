...
<body>
    <section id="tiket">
        ...
        <div class="row"><h3>Penerbangan</h3></div></div>
        <div class="container">
            <div class="row">
                <div class="col-md-4">
    ...
    <section id="data">
        <div class="container" style="background: none; margin-top:2%; padding-bottom:2%;"> 
        <div class="row"><h3>Detail Penumpang</h3></div></div>
        <div class="container" style="padding-bottom: 5%;">
            <div class="card">
                <div class="card-header">
                    ...
                    {{-- <img src="{{ asset('images/logo.svg') }}" alt="logo" style="width:3%;"><h3>NUSATEAS</h3> --}}
                </div>
                <div class="card-body">
                  <blockquote class="blockquote mb-0">
                    ...
                    <div class="row">Tanggal Lahir      :</div>
                    <div class="row">No Handphone       :</div>
                    <div class="row">Tujuan             :</div>
                    <div class="row">Layanan Pesawat    :</div>
                    <div class="row">Pembayaran         :</div>
                  </blockquote>
                </div>
              </div>
        </div>
